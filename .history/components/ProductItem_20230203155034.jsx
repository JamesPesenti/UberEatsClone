...
return (
   ...
   <Pressable onPress={onPress} style={styles.productDetails}>
      ...
      <View style={{flex: 1, flexDirection: 'row', marginHorizontal: 10, marginVertical: -10}}>
        <View style={{flexDirection: 'column', justifyContent: "center", alignItems: 'center', marginHorizontal: 20}}>
            ...
            />
             <View style={{flexDirection: 'row', alignItems: "center", }}>
                <Text style={{marginLeft: 100, backgroundColor: "pink", width: 30, height: 30, alignItems: "center", justifyContent: "center", borderRadius: 20}}>
                      {item.rating}
                </Text>
             </View>
        <View>
         ...
         <View style={styles.ratingsContainer}>
          {[0, 0, 0, 0, 0].map((el, i) => (
            <Image
              key={`${item.id}-${i}`}
              style={{margin: 3, justifyContent: "center", alignItems: "center", textAlign: "center", width: 20, height: 20}}
        ...
        <View style={{flexDirection: "row", margin: 20, marginBottom: 20}}>
            {/* <QuantityButtons
                quantity={quantity}
