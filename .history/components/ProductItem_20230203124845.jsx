...
return (
   ...
   <Pressable onPress={onPress} style={styles.productDetails}>
      ...
      <View style={{flex: 1, flexDirection: 'row', marginHorizontal: 10, marginVertical: -10}}>
        <View style={{flex: 1, flexDirection: 'column', justifyContent: "center", alignItems: 'center', marginHorizontal: 0}}>
            <Image 
                style={{flex: 1, borderRadius: 100, width: 150, height: 150, resizeMode: 'contain'}} 
                source={{uri: item.image }} 
            />
             <View style={{flexDirection: 'row', alignItems: "center", }}>
                <Text style={{marginLeft: "auto", backgroundColor: "lightgray", width: 30, height: 30, alignItems: "center", justifyContent: "center", borderRadius: 20}}>
                      {item.rating}
                </Text>
             </View>
        <View>
