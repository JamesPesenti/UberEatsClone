            ...
            />
             <Tab.Screen 
                ...
                tabBarIcon: ({color}) => {
                    return (
                        <Image 
                            source={{uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl74luhp_nnarKvY3ncNnK6Inj37-hEVF8_Q&usqp=CAU"}}
                            style={{
                                width: 50,
                                height: 50,
                                borderRadius: 50,
            ...
            />
             <Tab.Screen 
                ...
                tabBarIcon: ({color}) => {
                    return (
                        <Image 
                            source={{uri: "https://theglobecafe.com/wp-content/uploads/sites/70/2016/09/deliver-ubereats.png"}}
                            style={{
                                width: 50,
                                height: 50,
                                borderRadius: 50,
