...
const BasketContextProvider = ({children}) => {
    ...
    const totalPrice = basketDishes.reduce(
        (sum, basketDishes) => sum + basketDishes.quantity * basketDishes.price,
    ...
    return (
        <BasketContext.Provider value={{addDishToBasket, setRestaurant, restaurant, basket, basketDishes, totalPrice}}>
            {children}
