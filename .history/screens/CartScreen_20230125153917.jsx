...
const CartScreen = () => {
    ...
    // useEffect(() => {
    //     DataStore.query(CartProducts).then(setCartProducts);
    //   }, []);

    // useEffect(() => {

    //   // const fetchProducts = async () => {
    //  const products = Promise.all(cartProducts.map(cartProduct => DataStore.query(Product, cartProducts.productID)))
    // })}
