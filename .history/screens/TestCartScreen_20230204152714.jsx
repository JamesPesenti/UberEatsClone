    ...
    <>
     <ScrollView>
        ...
        <Text style={styles.titleText}>Shopping Cart</Text>
            <View style={{marginTop: 50, justifyContent: 'center', alignItems: "center", textAlign: 'center'}}>
            {/* Dollar amount of order */}
            <Text style={styles.addToCart}> <Text style={styles.addToCartPink}>{quantity}</Text> *DONUT* In Your Cart &#8226; <Text style={styles.addToCartPink}>${totalPrice()}</Text></Text>
            {/* <Text 
