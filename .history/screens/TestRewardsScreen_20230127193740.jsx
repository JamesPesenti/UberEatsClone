...
import { Keyboard, ScrollView, KeyboardAvoidingView, StyleSheet, Text, TextInput, Pressable, View, Dimensions  } from 'react-native'
...
const TestRewardsScreen = () => {
    ...
    // Firestore
    const todoRef = firebase.firestore().collection("AddText")
