...
return (
    <>
      <ImageBackground
        style={{width: width, height: height, backgroundColor: "#F0F0F0"}}
      >
      <View>
        {backButton()}
      </View>
...
{/* Product List */}
      <View style={styles.dishContainer}>
        <Image style={{width: 120, height: 120, borderRadius: 100, marginBottom: 20}} source={{ uri: dish.image}} />
          <Text style={styles.textStyle}>{dish.price}</Text>
          <Text style={styles.textStyle}>{dish.description}</Text>                      
